...
const TagPage: React.FC<{
  ...
  <Layout title={`标签: ${tagName}`} data={data}>
    <div className="card-base px-8 py-6">
      <div>
        <div
          className="w-full flex items-center gap-2 mb-3 transition text-3xl font-extrabold text-75 tracking-tight"
        >
            ...
            >
              <div className="flex flex-row justify-start items-center h-full">
                <div className="w-[15%] md:w-[10%] transition text-sm text-right text-50">
                  {dayjs(article.date || article.created_time).format('MM-DD')}
                </div>
