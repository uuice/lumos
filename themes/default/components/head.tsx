  ...
  return (
    <div id="navbar" className="z-50 onload-animation">
      ...
      <div className="card-base !overflow-visible max-w-[var(--page-width)] h-[4.5rem] !rounded-t-none mx-auto flex items-center justify-between px-4">
        ...
        >
          <div className="flex flex-row text-[var(--primary)] items-center text-md">
            <svg
              width="1em"
              height="1em"
              className="text-[1.75rem] mb-1 mr-2"
        ...
        <div className="flex">
          ...
          >
            <svg
              ...
              data-icon="material-symbols:menu-rounded"
            >
        ...
        <div
          id="nav-menu-panel"
          className="float-panel float-panel-closed transition-all fixed right-4 px-2 py-2"
        >
          <a
            href="/"
          ...
          >
            ...
            <svg
              width="1em"
              height="1em"
              className="transition text-[1.25rem] text-[var(--primary)]"
          ...
          >
            ...
            <svg
              ...
              height="1em"
              viewBox="0 0 512 512"
              className="transition text-[0.75rem] text-black/25 dark:text-white/25 -translate-x-1"
              data-icon="fa6-solid:arrow-up-right-from-square"
            >
              <use href="#ai:fa6-solid:arrow-up-right-from-square"></use>
            </svg>
